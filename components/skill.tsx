...
const SkillsSection: React.FC = () => {
  const skills: Skill[] = [
    { category: "Programming Languages", items: ["JavaScript", "TypeScript", "C++", "Python", "SQL"] },
    ...
    { category: "Miscellaneous", items: ["Docker", "AWS", "Supabase", "MongoDB", "Redis", "CI-CD Pipelines", "Unit-Testing"] },
  ];
